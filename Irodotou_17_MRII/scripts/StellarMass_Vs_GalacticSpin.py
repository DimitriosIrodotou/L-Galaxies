...
plt.plot(np.power(10, FR18['Mstar'][0:2]), np.power(10, FR18['jstar'][0:2]), color='blue', lw=lw, linestyle='dashed',
         label=r'$\mathrm{Fall\; &\; Romanowsky\, 18:Disks}$', zorder=4)
...
legend = plt.legend([circles], [r'$\mathrm{This\; work:M_{b} / M_{\bigstar} < 0.8}$'], scatterpoints=len(colors),
...
# Save the figure #
plt.savefig('SM_Vs_GS_58-' + date + '.png')