...
# Trim the data #
index = np.where(StellarMass > 0.0)

PB_Mass = PBMass[index] * MassUnits
CB_Mass = CBMass[index] * MassUnits
Disk_Mass = DiskMass[index] * MassUnits
Bulge_Mass = BulgeMass[index] * MassUnits
Stellar_Mass = StellarMass[index] * MassUnits
CB_Mass_Major = CBMassMajor[index] * MassUnits
CB_Mass_Minor = CBMassMinor[index] * MassUnits
...
ax2.set_xlim(1e6, 5e12)
ax4.set_xlim(1e6, 5e12)
ax5.set_xlim(1e6, 5e12)
ax7.set_xlim(1e6, 5e12)
ax10.set_xlim(1e6, 5e12)
ax12.set_xlim(1e6, 5e12)
...
ax1.annotate("", xy=(0.5, 0.01), xycoords='axes fraction', xytext=(0.8, 0.5),
             arrowprops=dict(arrowstyle="-", color='green', connectionstyle="arc3,rad=0"))

ax3.annotate(r'$\mathrm{M_{\bigstar}}$', xy=(-0.5, 1.01), xycoords='axes fraction', xytext=(0.5, 1.2),
             textcoords='axes fraction', arrowprops=dict(arrowstyle="-", color='red', connectionstyle="arc3,rad=0"))

ax3.annotate(r'$\mathrm{M_{\bigstar}}$', xy=(1.5, 1.01), xycoords='axes fraction', xytext=(0.5, 1.2),
             textcoords='axes fraction', arrowprops=dict(arrowstyle="-", color='blue', connectionstyle="arc3,rad=0"))

ax3.annotate("", xy=(0.6, 0.01), xycoords='axes fraction', xytext=(0.25, 0.5),
             arrowprops=dict(arrowstyle="-", color='orange', connectionstyle="arc3,rad=0"))

ax8.annotate("", xy=(0.6, 0.01), xycoords='axes fraction', xytext=(0.25, 0.5),
              arrowprops=dict(arrowstyle="-", color='cyan', connectionstyle="arc3,rad=0"))

ax6.annotate("", xy=(0.5, 0.01), xycoords='axes fraction', xytext=(0.8, 0.5), textcoords='axes fraction',
             arrowprops=dict(arrowstyle="-", color='magenta', connectionstyle="arc3,rad=0"))
