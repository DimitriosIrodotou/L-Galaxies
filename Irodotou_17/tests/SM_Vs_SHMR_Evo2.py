...
NRE12_1_15 = np.genfromtxt('NRE12_1_15.csv', delimiter=',', names=['x', 'y'])
plt.plot(np.power(10, NRE12_1_15['x'][0:2]), NRE12_1_15['y'][0:2], color='b', linestyle='dashed', lw=3,
         label=r'$\mathrm{Newman+12\, 1-\sigma}$')
plt.plot(np.power(10, NRE12_1_15['x'][2:4]), NRE12_1_15['y'][2:4], color='b', linestyle='solid', lw=3,
         label=r'$\mathrm{Newman+12 (fr.par.\, slope)}$')
plt.plot(np.power(10, NRE12_1_15['x'][4:6]), NRE12_1_15['y'][4:6], color='g', linestyle='dotted', lw=3,
         label=r'$\mathrm{Newman+12 (fixed\, slope)}$')
plt.plot(np.power(10, NRE12_1_15['x'][6:8]), NRE12_1_15['y'][6:8], color='b', linestyle='dashed', lw=3)
...
plt.annotate("$\mathrm{1.0 < z < 1.5}$", xy=(0.1, 0.9), xycoords='axes fraction', fontsize=20)
