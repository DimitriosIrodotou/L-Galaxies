...
HMS12_n_08_11 = np.genfromtxt('HMS12_n_08_11.csv', delimiter=',', names=['x', 'y'])
plt.plot(np.power(10, HMS12_n_08_11['x']), np.power(10, HMS12_n_08_11['y']), color='b',
         linestyle='dashed', label=r'$\mathrm{Huertas-Company+12(n>2.5)}$', zorder=4)

HMS12_BT_08_11 = np.genfromtxt('HMS12_BT_08_11.csv', delimiter=',', names=['x', 'y'])
plt.plot(np.power(10, HMS12_BT_08_11['x']), np.power(10, HMS12_BT_08_11['y']), color='b',
...
plt.annotate(r'$\mathrm{0.78 < z < 1.14 }$', xy=(0.1, 0.9), xycoords='axes fraction')
plt.savefig('SM_Vs_SHMR_Evo7-' + snap + date + '.png')