...
HMS12_n_05_08 = np.genfromtxt('HMS12_n_05_08.csv', delimiter=',', names=['x', 'y'])
plt.plot(np.power(10, HMS12_n_05_08['x']), np.power(10, HMS12_n_05_08['y']), color='b',
         linestyle='dashed', label=r'$\mathrm{Huertas-Company+12(n>2.5)}$', zorder=4)

HMS12_BT_05_08 = np.genfromtxt('HMS12_BT_05_08.csv', delimiter=',', names=['x', 'y'])
plt.plot(np.power(10, HMS12_BT_05_08['x']), np.power(10, HMS12_BT_05_08['y']), color='b',
...
plt.annotate(r'$\mathrm{0.51 < z < 0.78 }$', xy=(0.1, 0.9), xycoords='axes fraction')
plt.savefig('SM_Vs_SHMR_Evo6-' + snap + date + '.png')